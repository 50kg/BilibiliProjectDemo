...
public class PandaGameQuictAdapter extends BaseQuickAdapter<PandaGameBean.DataBean, BaseViewHolder> {

    public PandaGameQuictAdapter(int layoutResId, List<PandaGameBean.DataBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder holder, PandaGameBean.DataBean item) {
